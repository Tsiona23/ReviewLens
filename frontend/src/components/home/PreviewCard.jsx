      ...
      >
        ...
        <div className="relative flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-300/20 bg-blue-300/10 px-3 py-1 text-xs uppercase tracking-widest text-blue-300">
            ...
            >
              <motion.div variants={statItemVariants}>
                <div className="rounded-lg border border-gray-800 bg-black/50 p-3 text-center">
                  <p
          ...
          >
            <motion.div variants={statItemVariants}>
              <Card className="border border-gray-800 bg-black/50 p-3 text-center">
                <p
          ...
          {/* Verdict */}
          {data.verdict && (
            <div className="rounded-lg border border-blue-300/20 bg-blue-300/5 p-4">
              <h3 className="mb-4 font-semibold text-blue-300">
                AI Verdict
              </h3>
