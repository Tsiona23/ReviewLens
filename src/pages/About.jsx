      ...
      <Container>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12 text-gray-300">
            <div>
              <h2 className="text-3xl font-semibold text-blue-300 mb-4 border-b border-gray-700 pb-2">Why We Built ReviewLens</h2>
            ...
            <div>
              <h2 className="text-3xl font-semibold text-blue-300 mb-4 border-b border-gray-700 pb-2">Mission</h2>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h2 className="text-3xl font-semibold text-blue-300 mb-4 border-b border-gray-700 pb-2">How It Works</h2>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h2 className="text-3xl font-semibold text-blue-300 mb-4 border-b border-gray-700 pb-2">Technology Stack</h2>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h2 className="text-3xl font-semibold text-blue-300 mb-4 border-b border-gray-700 pb-2">Roadmap</h2>
            ...
            <div>
              <h2 className="text-3xl font-semibold text-blue-300 mb-4 border-b border-gray-700 pb-2">GitHub</h2>
              <p className="text-lg leading-relaxed">
              ...
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 text-lg text-blue-300 hover:text-blue-400 transition-colors"
              >
                <GitFork size={20} />
